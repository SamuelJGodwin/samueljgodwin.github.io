<?php
/**
 * Default template part for displaying portfolio items in item format
 *
 * @since 1.0.0
 */
...
<div id="entry-item-<?php the_ID(); ?>" <?php post_class( 'entry-item' ); ?>>
	...
	<div class="entry-item-content">
		...
		<?php the_terms( get_the_ID(), 'ignition_portfolio_category', '<div class="entry-item-excerpt">', ', ', '</div>' ); ?>
