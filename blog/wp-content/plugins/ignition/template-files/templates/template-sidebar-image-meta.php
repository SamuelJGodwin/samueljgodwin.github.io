<?php
/**
 * Template Name: Sidebar Image with Metadata
 * Template Post Type: ignition-discography, ignition-event, ignition-team
 *
 * The "Template Post Type" entry above may no be applicable to all listed post types.
 * Check add_theme_support( 'ignition-template-sidebar-image-meta' ).
 *
 * @since 1.1.0
 */
		...
		<div class="row <?php ignition_the_row_classes(); ?>">
			...
			<div id="site-content" class="<?php ignition_the_container_classes(); ?>">
				...
				<?php while ( have_posts() ) : ?>
					...
					<?php ignition_get_template_part( 'template-parts/single/sidebar-image-meta/content', get_post_type() ); ?>
				<?php endwhile; ?>
