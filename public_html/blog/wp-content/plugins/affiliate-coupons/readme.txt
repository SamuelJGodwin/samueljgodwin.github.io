...
* Browse [issue tracker](https://github.com/deetronix/affiliate-coupons/issues) on GitHub
...
* "WordPress" word removed from title as per guideline  

= Version 1.7.1 (12 Sep 2024) =
* fix : descripton can be styled using html tags  

= Version 1.7 (01 Sep 2024) =
* plugin tested upto WordPress v6.6.1
* new : option to show the vendor logo over the coupon added 
* new : action hook 'affcoups_add_after_button' added to add custom code below coupon button.  
* Tweak : added code to support pro feature

= Version 1.6.10 (05th Mar 2024) =
* plugin tested upto WordPress v6.4.3
* Fix : Image field not appearing and date selector not appearing due to conflict of metabox with elementor, fixed.

= Version 1.6.9 (06th Dec 2023) =
* plugin tested upto WordPress v6.4.1
* Fix : additional news added by plugin to the "WordPress events and news" widget in the admin dashboard have been removed as per wordpress guideline

= Version 1.6.8 (15th Aug 2023) =
* plugin tested upto WordPress v6.3
* Tweak : added code to support pro feature

= Version 1.6.7.8 (25th Jun 2023) =
* New : Option to hide Coupon Title and Coupon Description added.
* Updated Quickstart Guide


= Version 1.6.7.7 (1st Feb 2023) =
* New : Excerpt length option for Grid template added.
* Tweak : added code to support pro feature

= Version 1.6.7.6 (12th Dec 2022) =
* plugin tested upto WordPress v6.1.1

= Version 1.6.7.5 (24th Jul 2022) =
* Tweak : added code to support pro feature

= Version 1.6.7.4 (28th Jun 2022) =
* plugin tested upto WordPress v6.0
* Tweak : added code to support pro feature

= Version 1.6.7.3 (5th May 2022) =
* plugin tested upto WordPress v5.9.3

= Version 1.6.7.2 (9th Jan 2022) =
* Updated stable tag
...
* New: Added "Show all coupons" / "Show active coupons only" feature
