<?php
/**
 * The template for the default archives fallback
 *
 * @since 1.0.0
 */
			...
			<div id="content-row" class="<?php ignition_the_container_classes(); ?>">
				<?php
					if ( have_posts() ) :
						...
						$layout  = get_theme_mod( 'blog_archive_posts_layout_type', ignition_customizer_defaults( 'blog_archive_posts_layout_type' ) );
						$classes = array();
