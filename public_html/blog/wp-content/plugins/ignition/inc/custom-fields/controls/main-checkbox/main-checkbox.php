 ...
 * }
 */
function ignition_main_metabox_checkbox( $fieldname, $params = array() ) {
	$defaults = array(
		'title'         => '',
		'description'   => '',
		'checked_value' => 1,
	...
	<div class="ignition-setting-wrap">
		<div class="ignition-setting-control-checkbox">
			<?php if ( $params['title'] ) : ?>
				<label class="ignition-setting-checkbox-label" for="<?php echo esc_attr( $fieldname ); ?>">
					<input
						type="checkbox"
